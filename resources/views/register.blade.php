...
<body>
    <div class="container">
        <div class="mb-5">
            <img src="https://p1-news.hfcdn.com/p1-news/MzMzMDQ2NG5ld3M,/60e648faf85d2cf2_1000x500.jpg/qs/w=600&h=600&r=16888" class="banner">
        </div>
        ...
        <div class="input-group">
            ...
            <div class="d-grid gap-2">
                <button type="submit" id="submit" class="form-control btn btn-secondary"> Sign Up </button>
            </div>
